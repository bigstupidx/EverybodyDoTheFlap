/*	http://wiki.unity3d.com/index.php?title=AdvancedLabel
*	Author: Bérenger
*
*	Description:
*		Display a label the way you're used to, and add the modifiers you need. 
*		You can draw a label with a specific size, color, font, color or alignement 
*		(feel free to add new ones), any changes are reversed after the label is 
*		drawn. This is a much simpler but less powerfull alternative to fancy labels 
